...
const districts = [
  ...
  "Rangamati", "Habiganj", "Moulvibazar", "Sunamganj", "Sylhet",
  "Bagerhat", "Chuadanga", "Jessore", "Jhenaidah", "Khulna", "Kushtia",
  "Magura", "Meherpur", "Narail", "Satkhira", "Faridpur", "Gopalganj",
  "Kishoreganj", "Madaripur", "Manikganj", "Munshiganj", "Rajbari",
  "Shariatpur", "Jashore"
];
...
const Register = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  console.log("📝 Form data:", { name, email, bloodGroup, district, upazila });
  ...
  try {
    ...
    // 4️⃣ Save user to MongoDB (WITHOUT password - Firebase handles authentication)
    const userInfo = {
      name,
      email,
      // ❌ NO PASSWORD - Firebase manages authentication
      avatar,
      bloodGroup,
      district,
      upazila,
    ...
    <div className="hero min-h-screen bg-base-200 py-12">
      <div className="hero-content flex-col lg:flex-row-reverse max-w-6xl w-full">
        <div className="text-center lg:text-left lg:w-1/2">
          ...
          <p className="py-6">
            Join our blood donation platform and help save lives. Register as a donor and make a difference in your community.
          </p>
        </div>
        ...
        <div className="card w-full lg:w-1/2 shadow-2xl bg-base-100">
          <div className="card-body">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Avatar (Profile Photo) *</span>
                </label>
                <input
                  type="file"
                  name="avatar"
              ...
              {/* Upazila Text Input (Manual Entry) */}
              <div className="form-control">
                <label className="label">
